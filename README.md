...
A multi-page static web app (no install, no build dependencies, runs on GitHub Pages) with:
...
- **Exam topic infographics** ([`infographics/`](infographics/)) — visual one-pagers organized by v1.2 exam domain, with fast WebP previews
- **36 hands-on CML labs** ([`labs/`](labs/)) — full graded lab guides plus importable CML topology YAMLs, grouped by exam domain
...
| File | What it is |
|---|---|
| [`index.html`](index.html) | Study app home — links to `quiz.html`, `flashcards.html`, `cheatsheets.html`, `infographics.html`, `labs.html` (shared assets in [`assets/`](assets/)) |
